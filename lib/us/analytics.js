...
// GA4 is configured inside the GTM container, not here. These event names are a contract
// with that container: renaming one silently breaks its tag, with no build error.
